...
import PickerIndustry from './components/PickerIndustry'
...
class app extends PureComponent {
  ...
  componentDidMount() {
    ...
    fetch(`https://www.bayes.citystgeorges.ac.uk/webservices/funnelback-find-dxp?form=json&collection=city~sp-bayes-student-profiles&meta_L_sand=MSC&sort=date`)
      ...
      <div className="student-profiles-search">
        <div className="student-profiles-search__top">
          ...
          <div className="student-profiles-search__filters">
            <PickerIndustry value={selectedIndustry}
